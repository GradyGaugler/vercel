...
export default function SecurityControlsPage() {
  ...
  return (
    <div className="min-h-screen bg-[#1e1e1e] text-white flex justify-center">
        ...
        <div>
            ...
            <div className="flex justify-between items-start">
              <div className="flex-1 mr-4">
                <p className="text-gray-300 text-sm">
                  Anyone in your organization can invite other users to it. If you turn this on, the invites will
                  require an admin, billing contact, or owner to approve the invite before joining your organization.
                </p>
              </div>
              <Switch
          ...
          <div className="mb-8">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="px-2 py-0.5 text-xs bg-[#a881fc] bg-opacity-30 text-[#a881fc] rounded">
                Experimental
              </span>
            </div>
